...
<header class="container-fluid main-header">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4"> 
            <?= Html::img(Yii::$app->request->baseUrl . "/img/logo.png",["class"=>"logo img-responsive"]) ?> </div>
        <div class="col-sm-12 col-md-8 text-right">  
            <div class="row">
                <div class="col-sm-12 header-login">
                    <?= Yii::$app->user->isGuest ? (Html::a('Iniciar Sesión', 'login',['class'=>'btn btn-primary'])) : ('no'); ?>
                </div>
                <div class="col-sm-12">
                    <?= '¿No tienes cuenta? ' . Html::a('Registrate','#'); ?>
                </div>
            </div>
        </div>
    </div>
